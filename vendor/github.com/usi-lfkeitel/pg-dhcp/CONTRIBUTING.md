...
If you are planning to contribute a significant change, please draft a design document (or start a conversation) and post it to the [issue tracker](https://github.com/usi-lfkeitel/pg-dhcp/issues). This will allow other developers and users to discuss the proposed change.
